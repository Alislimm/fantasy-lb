    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          {/* Player Jersey */}
          <View style={[styles.modalJersey, { backgroundColor: '#666666' }]}>
            <View style={styles.jerseyOutline} />
            <View style={styles.vNeck} />
            <View style={[styles.sidePanel, styles.leftPanel]} />
            <View style={[styles.sidePanel, styles.rightPanel]} />
          ...
          <View style={styles.modalPlayerInfo}>
            <Text style={styles.modalPlayerName}>{player.firstName} {player.lastName}</Text>
            <Text style={styles.modalPlayerTeam}>{player.team.name}</Text>
            <View style={styles.modalStats}>
              ...
              <View style={styles.statItem}>
                ...
                <Text style={styles.statValue}>{player.team.name}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.statsContainer}>
            ...
            >
              <View style={styles.statsGrid}>
                ...
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>
                    ${[...teamData.starting, ...teamData.bench].reduce((total, player) => total + (player.marketValue || 0), 0).toFixed(1)}M
                  </Text>
